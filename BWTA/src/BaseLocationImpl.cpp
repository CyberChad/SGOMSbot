...
namespace BWTA
{
  ...
  //{
  //  return this->initialGeysers;
  //}
  const std::set<BWAPI::TilePosition>& BaseLocationImpl::getGeysersPosition() const
  {
    return this->positionGeysers;
  }
  ...
  {
    return this->initialGeysers.empty();
  }
